  ...
  return (
    <main className="w-full min-h-screen flex flex-col">
      ...
      <section className="w-full h-[56px] md:h-[72px] flex items-center px-6 md:px-32">
        <div className="flex items-center gap-2 cursor-pointer ml-0 md:ml-32 w-[146px] h-[24px]">
...
>
  ...
  <div className="w-full max-w-[1280px] flex flex-col gap-3">
    <h1 className="font-archivo font-bold text-[#3B3B3B] tracking-[0.4px]
                   text-[24px] leading-[28px] md:text-[36px] md:leading-[40px]">
      Your Cart
    </h1>
    <span className="font-archivo font-normal text-[#3B3B3B] tracking-[0.4px]
